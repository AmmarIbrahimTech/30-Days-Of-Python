...
print(f"The area of the triangle equals {round(area,2)}")
...
print("Let's point out two points on the x-y plane!")                   #*float *
...
print(f"The type of '10' is equal to type of 10 is a {type('10') is type(10)} statement.")
