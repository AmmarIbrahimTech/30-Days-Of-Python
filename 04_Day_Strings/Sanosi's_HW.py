...
# TODO ----------------------------------
#* not the best practic
"""you don't know the first word length"""
...
#15
print(f"The character at index 0 in the string '{company}' is '{company[0]}'")

#16
print(f'The last index of the string "{company}" is {company.rfind('l')}')
# TODO last_index = len(company) - 1

#17
print(f"The character at index 10 in '{company}' is '{company[10]}'")

#18
company_acronym1 = company[0]
company_acronym2 = company[7]
company_acronym3 = company[11]
